...
class BaseSampler(metaclass=ABCMeta):
    ...
    def sample(self, assign_result, bboxes, gt_bboxes, gt_labels=None, **kwargs):
        ...
        Example:
            >>> from mmdet.foundation_stereo.bbox import RandomSampler
            >>> from mmdet.foundation_stereo.bbox import AssignResult
            >>> from mmdet.foundation_stereo.bbox.demodata import ensure_rng, random_boxes
            >>> rng = ensure_rng(None)
